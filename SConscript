...
all_manpages = {
    ...
    "man/gpslogntp.1": "man/gpslogntp.adoc",
...
templated = {
    ...
    "clients/gpslogntp": "clients/gpslogntp.py.in",
...
upload_release = Utility('upload-release', ['dist'], [
    ...
    'scp -O gpsd-${VERSION}.tar.* gpsd-${VERSION}.zip* ' + scpupload,
])
