...
:robots: index,follow
:title: Building GPSD from source
:toc:
...
To rebuild files from AsciiDoc (.adoc) files you need one of:

|============================================================================
|asciidoctor        | Documentation front end with light markup
|asciidoc           | Documentation front end with light markup
|============================================================================
...
|app-text/asciidoc                | Documentation front end with light markup
|==============================================================================
