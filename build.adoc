...
Linux kernel team).  You will need the libusb development headers in this case.

Under Debian/Ubuntu this is the package:

|==============================================================================
|libusb-1.0-0-dev	| D-Bus Development package
|==============================================================================
...
For working with D-Bus, you'll need the D-Bus development
...
On Gentoo the package will already be installed if D-Bus is in use:
