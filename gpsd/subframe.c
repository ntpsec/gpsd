                               ...
                               unsigned int numwords)
{
    ...
    case 1:
        ...
        subp->orbit.AODC = (words[1] >> 12) & 0x01f;          // AODC
        // subp->URAI = (words[1] >> 8) & BITMASK(4);
        subp->WN = (words[2] >> 17) & 0x01fff;                // WN
        ...
        subp->orbit.AODE = (words[8] >> 8) & 0x01f;           // AODE
