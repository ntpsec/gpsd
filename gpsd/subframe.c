...
#define uint2int(u, bit) ((u & (1LL<<(bit-1))) ? u - (1LL<<bit) : u)
                               ...
                               unsigned int numwords)
{
    ...
    case 1:
        ...
        subp->orbit.toc = ((words[2] >> 8) & 0x0ff) << 8;  // toc
