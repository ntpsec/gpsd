...
typedef enum {
    ...
    UBX_NAV_DAHEADING   = UBX_MSGID(UBX_CLASS_NAV, 0x45),
    ...
    UBX_NAV_PVAT        = UBX_MSGID(UBX_CLASS_NAV, 0x17),
    ...
    UBX_RXM_COR         = UBX_MSGID(UBX_CLASS_RXM, 0x34),
    ...
    UBX_RXM_SPARTN      = UBX_MSGID(UBX_CLASS_RXM, 0x33),
    UBX_RXM_SPARTNKEY   = UBX_MSGID(UBX_CLASS_RXM, 0x36),
