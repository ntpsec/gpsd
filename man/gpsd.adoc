...
*/@RUNDIR@/chrony.XXX.sock*::
  When *chronyd* is started, it may create this file.  When *gpsd* is
  started, it will open this file if it exists.  Then *gpsd* will put
  PPS timing information in the file for *chronyd* to use to correct the
  system clock.
