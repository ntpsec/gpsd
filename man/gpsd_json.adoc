...
|magdev |No |numeric |Magnetic deviation, degrees.
It is the error in a compass reading due to local magnetic
influences from the vessel or aircraft itself.  Positive is West
deviation. Negative is East deviation.
...
----
{"class":"ATT","time":"2010-06-04T10:31:00.289Z",
...
[UTC-TAU] table of leap second corrections).
...
[[UTC-TAI]]: https://maia.usno.navy.mil/ser7/tai-utc.dat USNO table of +
UTC to TAI corrections.
