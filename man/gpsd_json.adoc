...
is not 2D or 3D.  May be present, but invalid, irfs no fix.  Verify
3 consecutive 3D fixes before beliving it is UTC.  Even then it may be
off by several seconds until the current leap secinds is known.
