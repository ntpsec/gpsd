...
test2 = [(48.864710, 2.373051, "JN18eu47sm", "Paris"),
         (41.934982, 12.436523, "JN61fw24jj", "Rome"),
         (39.97714, -75.16855, "FM29jx94sm", "Philadelphia, PA USA"),
...
test5 = [(0, 0, 0, 6378137, 0, 0),
         ...
         # a typical GPS sat
         (28.4, 74.4, 20073000.065, 6258290.772, 22414678.807, 12562777.312),
         (-34.2, -172.3, 20240000.113,
          -21822373.137, -2950500.608, -14941384.507),
         (44.0, -155.5, 20240000.201,
          -17430229.809, -7943413.363, 18467977.030),
         ]
...
test6 = [(0, 0, 0, 6378137, 0, 0),
         ...
         # typical GPS sats
         (28.4, 74.4, 20073000, 6258290.772, 22414678.807, 12562777.312),
...
test7 = [(1, 0, 0, 0, 0, 0, 0, -90.000, 6378136.000),
