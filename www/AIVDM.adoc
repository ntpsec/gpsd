...
http://www.maritec.co.za/aisvdmvdodecoding[The Maritec decoder]
...
this pad byte has a tricky interaction with the <<ITU1371>>
...
This checksum is the XOR of all bytes in the payload.
...
and NMEA checksum are required, but the payload fields may contain any
encapsulated data.
...
More information on the CNB is at <<MSGS123>>.
...
<<MSGS123>> for the field specification and <<SART>> for
background.
...
West = negative.  A value of 181 degrees (0x6791AC0 hex) indicates that
...
Decoders should be prepared to accept them as they are seen in the wild.
<<ITU1371>> specifies type value 15 (all field bits 1) as "Internal
GNSS".
...
|   1     | 17 |     | <<IMO289>>  | In use     | VTS-Generated/Synthetic targets
...
<<IMO289>> in favor of a message with the same title but FID = 31 and a
...
|55-66   | 11 |Air Draught          |airdraught|u|Height in 0.1m steps
                                                  0 = N/A (default),
                                                  204.7 = >= 204.7 m,
...
|56-65   | 10 |Message Linkage ID     |linkage       |u|Unsigned integer
|66-78   | 13 |Air Draught            |airdraught    |u|Unsigned int, in 0.01m
                                                        1-81.9 m.
                                                        0 = N/A (default)
                                                        81.91 = >= 81.91 m
...
IMO289 says air draught is in 0.1m steps, but this is incompatible with the
two digits of precision in the range.

The special value of 81.91 for air draught in <<IMO289>>, also implies
the step size is really 0.01m.
...
|0-0     | 1  |Water Level Type         |absolute   |b|False if relative to
                                                       reference datum.
|1-16    | 16 |Water Level              |level      |i|In 0.01 meter steps,
                                                      -327.67 to 327.67,
...
|======
|Field   |Len |Description         |Member     |T|Units
|0-12    | 13 |Air Draught         |airdraught |U1|1-81.9m in 0.01m steps,
                                                   8191 = distance >= 81.91m,
                                                   0 = N/A (default).
|13-25   | 13 |Air Gap             |airgap     |U1|1-81.9m in 0.01m steps,
                                                   8191 = distance >= 81.91m,
                                                   0 = N/A (default).
|26-27   |  2 |Air Gap Trend       |gaptrend   |e|0 = steady,
                                                   ...
                                                   2 = falling,
                                                   3 = N/A (default).
|28-40   | 13 |Forecast Air Gap    |fairgap    |U1|1-81.9m in 0.01m steps,
                                                   8191 = distance >= 81.91m,
                                                   0 = N/A (default).
...
IMO289 says steps are in 0.1m steps, but this is incompatible with the
two digits of precision in the range.
...
|263-270  |  8 |Type of ship and cargo |shiptype     |e|As in Message 5
...
|44-61   | 18   |Longitude           |lon      |I1|minutes/10
                                                  East positive, West negative
                                                  181000 = N/A (default)
|62-78   | 17   |Latitude            |lat      |I1|minutes/10
...
and there has not yet been much public discussion of it.  This section
...
One previous effort, JSON-AIS, has been made to define a JSON-based
standard for exchange of unpacked, human-readable AIS data. The latest
version at time of writing, from December 2008,covers only a small
subset of the most common AIS messages, and many data fields in the
messages it does dump are omitted.  Online links to the project have
disappeared as of June 2023.  The member names given in the bit-field
tables match the attributes used in HAM-JSON-AIS when HAM-JSON-AIS
includes that field.
...
- [[[IALA]]]  https://web.archive.org/web/20111110211252/https://www.ialathree.org/iala/pages/AIS/IALATech1.5.pdf[IALA
...
- [[[SEAWAY]]] https://greatlakes-seaway.com/wp-content/uploads/2020/05/Seaway-AIS-message-specifications-R41.pdf[St. Lawrence
  Seaway AIS Data Messaging Formats and Specifications]

- [[[THAMES]]] https://www.pla.co.uk/assets/APPENDIX_I__II_amendment_for_2012_byelaws_FINAL.pdf[Thames AIS - Technical Requirements Specification]

- [[[IMO236]]] https://www.navcen.uscg.gov/sites/default/files/pdf/IMO_SN1_Circ290_Guidance_on_presentation%20of%20AIS_ASM.pdf[IMO
-  Circular 236: Guidance on the Application of AIS Binary Messages (June 2010)]
...
- [[[ITU-MID]]] https://www.itu.int/en/ITU-R/terrestrial/fmd/Pages/mid.aspx[Table
...
- [[[MSGS123]]] https://www.navcen.uscg.gov/ais-class-a-reports[Class A AIS Position Report (Messages 1, 2, and 3)]

- [[[SART]]] https://en.wikipedia.org/wiki/AIS-SART

- [[[PATREON]]] https://www.patreon.com/esr

- [[[NMEA-ADVANCE]]] https://vdocuments.net/nmea-0183-advancements-2pdfl-luft-1010-nmea-0183-advancements-slide-11-new.html

- [[[Schwehr]]] https://ccom.unh.edu/user/schwehr
...
Version 1.36 corrects erroneous scale factors in the IMO289 Area
...
Version 1.57 Update Type 1/2/3 Nav Statusa, and EPFD, Descriptions. Fix dead
link to <<MSGS123>>.
