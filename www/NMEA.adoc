...
Indicator.  This is confirmed by <<IEC61162-1>>.
...
Note: Jackson Labs, Quectel and Telit sometimes use non-standard PRN
numbering.
...
1. UTC Time or observation, hh is hours, mm is minutes, ss.ss is seconds
2. Waypoint Latitude
3. N = North, S = South
...
1. UTC Time of observation, hh is hours, mm is minutes, ss.ss is seconds
2. Waypoint Latitude
3. N = North, S = South
4. Waypoint Longitude
5. E = East, W = West
...
1. UTC time of the GGA or GNS fix associated with this sentence.
     hh is hours, mm is minutes, ss.ss is seconds
...
The number of digits past the decimal point for Time, Latitude and
Longitude is model dependent.
...
1. UTC of position, hh is hours, mm is minutes, ss.ss is seconds.
2. Latitude, dd is minutes, mm.mm is minutes
3. N or S (North or South)
4. Longitude, dd is minutes, mm.mm is minutes
5. E or W (East or West)
...
Signal ID, just before the checksum.  See the description of Signal ID's
above.

Note: $GNGSV uses PRN in field 4.  Other $GxGSV use the satellite ID in
field 4.  Jackson Labs, Quectel, Telit, and others get this wrong, in
...
Unknown sentence.  Seen from Huawai GPS receivers.

Example: $GPHWBIAS,11.2*21
...
1. Target Number (0-99)
2. Target Latitude, dd is degrees, mm.mm is minutes.
3. N=north, S=south
4. Target Longitude, dd is degrees, mm.mm is minutes.
5. E=east, W=west
6. Target name
7. UTC of data, hh is hours, mm is minutes, ss.ss is seconds.
...
1. UTC of fix, hh is hours, mm is minutes, ss.ss is seconds.
2. Date, ddmmyy
3. Latitude, dd is degrees, mm.mm is minutes.
4. N or S
5. Longitude, dd is degrees, mm.mm is minutes.
6. E or W
7. Elevation Angle
...
1.  UTC time.  mm is minutes, ss.sss is seconds.
...
1. Filtered UTC offset in ns
2. Raw UTC offset in ns from the time interval counter,
3. Number of captured input 1PPS signals,
4. Lock status
5. EFC voltage
6. EFC percentage
7. Estimated frequency accuracy
8. Seconds in holdover
9. Number of satellites tracked.
10. Health status
...
5. Target alias. Can be changed when the target identification data is
   ...
   within the alias word. This field is variable length, at most 21
   characters.
