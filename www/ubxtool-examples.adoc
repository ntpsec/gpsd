...
Timepulse signals are configured using the UBX-CFG-TP5 message. This
is the message sent when you enable and disable the TIMEPULSE pin by means
of the PPS option. In particular, -d PPS is actually a shortcut for:
