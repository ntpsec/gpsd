...
simple spectrum analyzer for testing GNSS antennas.
...
- [[FREQ]] https://www.rfwireless-world.com/terminology/satellite-communication/gnss-gps-frequency-bands| GNSS and GPS Frequency Bands Explained
