...
While the need for changing what the Gen9 listens for is less, the
...
Another reason to always check your work hen using *ubxtool*.

u-blox recently recommended to a cold boot after changing
to some configurations of constellations:
