...
If the receiver is a 9-series, or higher, then you can change the model
...
An L2 Gen9-series may look like this:
...
The 8-series, and some 7-series, are problematic. Many of them can only
...
Starting around protocol version 27, in the 9- and 10-series devices, the
