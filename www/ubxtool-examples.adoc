...
The parameter to the RATE command is the number of milliseconds between
each fix.
...
1. u-blox 8 or 9 GNSS receiver (protocol version greater than 23.01)
...
>>>>>>> f15ed32f2 (Proofread the examples for typos, spelling ...)
